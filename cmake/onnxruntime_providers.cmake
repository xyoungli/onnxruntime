...
if(onnxruntime_USE_ARM)
  set(PROVIDERS_ARM onnxruntime_providers_arm)
  list(APPEND ONNXRUNTIME_PROVIDER_NAMES arm)
endif()
...
install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../include/onnxruntime/core/providers/cpu  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers)
...
if (onnxruntime_USE_CUDA)
  ...
  target_include_directories(onnxruntime_providers_cuda PRIVATE ${ONNXRUNTIME_ROOT} ${CMAKE_CURRENT_LIST_DIR}/external/cub ${onnxruntime_CUDNN_HOME}/include ${eigen_INCLUDE_DIRS} ${TVM_INCLUDES} PUBLIC ${CMAKE_CUDA_TOOLKIT_INCLUDE_DIRECTORIES})
  install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../include/onnxruntime/core/providers/cuda  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers)
...
if (onnxruntime_USE_DNNL)
  ...
  install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../include/onnxruntime/core/providers/dnnl  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers)
...
if (onnxruntime_USE_TENSORRT)
  ...
  include_directories(${CMAKE_CURRENT_LIST_DIR}/external/protobuf)
  ...
  install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../include/onnxruntime/core/providers/tensorrt  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers)
...
if (onnxruntime_USE_OPENVINO)
  ...
  install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../include/onnxruntime/core/providers/openvino  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers)
...
if (onnxruntime_USE_NUPHAR)
  ...
  install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../include/onnxruntime/core/providers/nuphar  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers)
endif()
...
if (onnxruntime_USE_DML)
  ...
  install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../include/onnxruntime/core/providers/dml  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers)
...
if (onnxruntime_USE_ACL)
  ...
  install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/../include/onnxruntime/core/providers/acl  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers)
...
if (onnxruntime_USE_ARM)
  ...
  source_group(TREE ${ONNXRUNTIME_ROOT}/core FILES ${onnxruntime_providers_arm_cc_srcs})
  add_library(onnxruntime_providers_arm ${onnxruntime_providers_arm_cc_srcs})
  onnxruntime_add_include_to_target(onnxruntime_providers_arm onnxruntime_common onnxruntime_framework onnx onnx_proto protobuf::libprotobuf)
  add_dependencies(onnxruntime_providers_arm ${onnxruntime_EXTERNAL_DEPENDENCIES})
  set_target_properties(onnxruntime_providers_arm PROPERTIES FOLDER "ONNXRuntime")
